...
class Player:
    ...
    def generateScoreModel(self):
        ...
        scoreModel = [
            ...
            # adding them may cause some unknown problems
        ...
        """
        self.scoreModel.append([1, [2, 1, 0], False])
        for level in range(1, self.target):
            score = int(math.pow(10, level))
            self.scoreModel.append([score])
...
if __name__ == '__main__':
    testPlayer = Player("black", 3, 3, [0 for _ in range(0, 9)])
